#
# Be sure to run `pod lib lint HSYRxSwiftToolsKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HSYRxSwiftToolsKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HSYRxSwiftToolsKit.'
